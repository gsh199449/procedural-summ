...
class ModelArguments(ArgClassBase):
    ...
    use_entity_graph: Optional[bool] = field(
        default=True, metadata={"help": "using graph result when decoding."}
    )
    use_kl_loss: Optional[bool] = field(
        default=False, metadata={"help": "using kl loss."}
    )
    concat_entity_graph: Optional[bool] = field(
        default=True, metadata={"help": "concat graph states to encoder state along src_len."}
    )
